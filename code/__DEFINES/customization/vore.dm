...
#define VORE_SOUND_TOGGLES_DEFAULT (NONE) //keep this defaulting to all of them off because vore sounds are more of a pref break than the rest of the vore toggles, a lot of people don't like the sounds in general, let them decide
...
#define MAX_BELLY_NAME_LENGTH 50 //yeah I dunno, adjust this if you want to
#define VORE_EATING_TIME (5 SECONDS)
#define MAX_VORE_FLAVOUR_TEXT_LENGTH 100
